import { HttpStatusCode } from '@phont/utils'
import { StatusError } from '@shared/status-error'
import { StatusSuccess } from '@shared/status-success'
...
export class StatusMapper implements IStatusMapper {
  ...
  public static withCustomErrorMappings(parameters: {
    customErrorMappings: ReadonlyMap<StatusError, HttpStatusCode>
  }): StatusMapper {
    return new StatusMapper({
  ...
  public static withCustomSuccessMappings(parameters: {
    customSuccessMappings: ReadonlyMap<StatusSuccess, HttpStatusCode>
  }): StatusMapper {
    return new StatusMapper({
